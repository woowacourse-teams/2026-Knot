...
class AuthenticatedMemberTest {
    ...
    void create_failure_invalidMemberId() {
        // when & then
        assertThatThrownBy(() -> AuthenticatedMember.of(0L, 42L, "octocat", null))
    ...
    void create_failure_invalidGithubId() {
        // when & then
        assertThatThrownBy(() -> AuthenticatedMember.of(1L, 0L, "octocat", null))
    ...
    void create_failure_overlongNickname() {
        // when & then
        assertThatThrownBy(() -> AuthenticatedMember.of(1L, 42L, "a".repeat(21), null))
                .isInstanceOf(AuthException.class);
    }
}

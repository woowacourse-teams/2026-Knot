ALTER TABLE notion_connections
    ADD CONSTRAINT uk_notion_connections_id_workspace UNIQUE (id, workspace_id);
...
CREATE TABLE notion_import_runs (
    ...
    CONSTRAINT fk_notion_import_runs_connection
        FOREIGN KEY (notion_connection_id, workspace_id)
        REFERENCES notion_connections (id, workspace_id)
        ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX uk_notion_import_runs_one_active
    ON notion_import_runs (notion_connection_id)

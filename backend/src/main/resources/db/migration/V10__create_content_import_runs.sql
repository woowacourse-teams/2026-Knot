...
CREATE TABLE content_import_runs (
    ...
    CONSTRAINT chk_content_import_runs_total_page_count
...
CREATE UNIQUE INDEX uk_content_import_runs_one_active
    ON content_import_runs (content_source_connection_id)
    WHERE status IN ('PENDING', 'RUNNING');

CREATE INDEX idx_content_import_runs_workspace_created
    ON content_import_runs (workspace_id, created_at DESC);

...
public class Member {
    ...
    private Member(long githubId, String nickname, String profileImageUrl) {
        validate(githubId, nickname, profileImageUrl);
    ...
    private static void validate(long githubId, String nickname, String profileImageUrl) {
        if (githubId <= 0) {
            throw new MemberException(MemberErrorCode.INVALID_MEMBER_DATA);
        }

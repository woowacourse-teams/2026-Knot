...
_GROUPS: dict[tuple[str, int], tuple[tuple[str, ...], ...]] = {
    ...
    ("G-005", 1): (
        ("2026년 8월 19일", "8월 19일", "2026-08-19"),
        ("로드맵",),
        ("인터뷰",),
    ),
    ("G-006", 1): (
        ("2026년 8월 14일", "8월 14일", "2026-08-14"),
        ("widget", "위젯"),
        ("feature", "피처"),
        ("shared/hooks", "shared vs feature", "훅"),
        ("미결", "확정되지", "논의"),
    ),
    ("G-007", 2): (
        ("로드맵",),
        ("level 3", "level3", "레벨 3", "레벨3"),
        ("기능", "feature"),
        ("흑곰", "기획안", "요구사항"),
    ),
    ("G-008", 2): (
        ("미결", "확정되지", "아직"),
        ("shared/hooks/domain", "shared/hooks"),
        ("feature",),
        ("두 번째", "두번째", "2회째", "여러 화면"),
    ),
    ("G-009", 1): (
    ...
    ("G-013", 2): (
        ("추가", "관련", "문서"),
        ("postgresql", "database", "데이터베이스", "migration", "테스트", "pgvector"),
    ),
...
def _has_group(answer: str, groups: tuple[tuple[str, ...], ...]) -> bool:
    return all(
        any(pattern.casefold() in answer for pattern in group) for group in groups
    )

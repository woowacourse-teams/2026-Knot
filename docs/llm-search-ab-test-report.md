...
- 동일한 모델·프롬프트·옵션으로 31개 case를 실행한 NIM e2e 결과
- 동일한 실행 ID로 기록한 cold/warm 조건과 MCP-live access 지연
- 사람 검수 33개 turn의 terminal pass/fail 라벨
- Java가 Workspace credential을 선택하고 Notion token을 NIM에 넘기지 않는 운영 경계 검증
